    ...
    companion object {
        ...
        private val CARD_MODELS = listOf(
            CardModel(
                ...
                listOf(
                    BinRange(
                        start = 4.toBigInteger(),
                        end = 4.toBigInteger(),
                        length = BinLength(value = 16, pattern = SpacingPatterns.Pattern_4_4_4_4)
                    )
                )
            ),
            CardModel(
                ...
                listOf(
                    BinRange(
                        start = 51.toBigInteger(),
                        end = 55.toBigInteger(),
                        length = BinLength(value = 16, pattern = SpacingPatterns.Pattern_4_4_4_4)
                    ),
                    BinRange(
                        start = 2221.toBigInteger(),
                        end = 2720.toBigInteger(),
                        length = BinLength(value = 16, pattern = SpacingPatterns.Pattern_4_4_4_4)
                    )
                )
            ),
            CardModel(
                ...
                listOf(
                    BinRange(
                        start = 37.toBigInteger(),
                        end = 37.toBigInteger(),
                        length = BinLength(value = 15, pattern = SpacingPatterns.Pattern_4_6_5)
                    ),
                    BinRange(
                        start = 34.toBigInteger(),
                        end = 34.toBigInteger(),
                        length = BinLength(value = 15, pattern = SpacingPatterns.Pattern_4_6_5)
                    )
                )
            ...
            CardModel(
                ...
                listOf(
                    BinRange(
                        start = 3528.toBigInteger(),
                        end = 3589.toBigInteger(),
                        length = BinLength(value = 16, pattern = SpacingPatterns.Pattern_4_4_4_4)
                    )
                )
            ),
            CardModel(
                ...
                listOf(
                    BinRange(
                        start = 36.toBigInteger(),
                        end = 36.toBigInteger(),
                        length = BinLength(value = 14, pattern = SpacingPatterns.Pattern_4_6_4)
                    )
                )
            ),
            CardModel(
                ...
                listOf(
                    BinRange(
                        start = 6011.toBigInteger(),
                        end = 6011.toBigInteger(),
                        length = BinLength(value = 16, pattern = SpacingPatterns.Pattern_4_4_4_4)
                    ),
                    BinRange(
                        start = 622126.toBigInteger(),
                        end = 622925.toBigInteger(),
                        length = BinLength(value = 16, pattern = SpacingPatterns.Pattern_4_4_4_4)
                    ),
                    BinRange(
                        start = 644.toBigInteger(),
                        end = 649.toBigInteger(),
                        length = BinLength(value = 16, pattern = SpacingPatterns.Pattern_4_4_4_4)
                    ),
                    BinRange(
                        start = 65.toBigInteger(),
                        end = 65.toBigInteger(),
                        length = BinLength(value = 16, pattern = SpacingPatterns.Pattern_4_4_4_4)
                    )
                )
            ...
            CardModel(
                ...
                listOf(
                    BinRange(
                        start = 6690.toBigInteger(),
                        end = 6690.toBigInteger(),
                        length = BinLength(value = 16, pattern = SpacingPatterns.Pattern_4_4_4_4)
                    ),
                    BinRange(
                        start = 9784.toBigInteger(),
                        end = 9784.toBigInteger(),
                        length = BinLength(value = 16, pattern = SpacingPatterns.Pattern_4_4_4_4)
                    )
                )
            )
