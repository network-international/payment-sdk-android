...
//        val language = locale.language.toLowerCase()
        ...
        products.add(ProductDomain("${products.size + 2}", "Furniture 6", "Just a furniture", listOf(Price(currency, BigDecimal(2345),  BigDecimal(0))), "file:///android_asset/images/02.jpg" ))
        return  products
    }
